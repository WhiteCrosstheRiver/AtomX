...
最新导入/导出与粒子外观修复说明见 [I/O 和粒子验证记录](docs/IO_AND_PARTICLE_VALIDATION.md)。应用已接入原生格式注册表、按格式显示选项的导出对话框、LAMMPS dump 轨迹、PDB/GRO 坐标读取，以及逐类型的真实三维粒子形状；下文历史功能说明尚未全部同步，以该验证记录的能力边界为准。
