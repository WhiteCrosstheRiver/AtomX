...
- Undo and redo exchange complete modifier-node snapshots without rewriting node IDs or color-coding trajectory-range settings; round-trip coverage guards the previous behavior that silently disabled all-frame color ranges on history restore.
